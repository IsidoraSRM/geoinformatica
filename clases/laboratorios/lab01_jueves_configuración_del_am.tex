...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Laboratorio 1} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Laboratorio 01: Configuración del ambiente}
...
\begin{frame}{Objetivos de hoy}
    \begin{itemize}
        \item Instalar R, RStudio y Python
        \item Configurar paquetes básicos
        \item Primer contacto con datos geoespaciales
        \item Verificar instalación correcta
    \end{itemize}
\end{frame}
...
\begin{frame}{Cierre}
    \begin{center}
        ...
        Próxima semana: Clase teórica 3
    \end{center}
\end{frame}
