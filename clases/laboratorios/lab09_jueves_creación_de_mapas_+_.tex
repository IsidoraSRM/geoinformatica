...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Laboratorio 9} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Laboratorio 09: Creación de mapas + Plan de proyecto}
\subtitle{Cartografía y planificación}
...
\begin{frame}{Objetivos de hoy}
    \begin{itemize}
        \item Diseño de mapas con tmap
        \item Definición formal del proyecto
        \item Personalización avanzada
        \item Revisión de fuentes de datos
    \end{itemize}
\end{frame}
...
\begin{frame}{Cierre}
    \begin{center}
        ...
        Próxima semana: Clase teórica 19
    \end{center}
\end{frame}
