...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Laboratorio 5} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Laboratorio 05: Manipulación de atributos}
\subtitle{dplyr + sf}
...
\begin{frame}{Objetivos de hoy}
    \begin{itemize}
        \item Filtrado y selección avanzada
        \item Joins espaciales complejos
        \item Agregación de datos
        \item Mini-proyecto demográfico
    \end{itemize}
\end{frame}
...
\begin{frame}{Cierre}
    \begin{center}
        ...
        Próxima semana: Clase teórica 11
    \end{center}
\end{frame}
