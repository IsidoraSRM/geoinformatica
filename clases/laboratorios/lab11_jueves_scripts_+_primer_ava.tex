...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Laboratorio 11} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Laboratorio 11: Scripts + Primer avance proyecto}
\subtitle{Automatización y revisión}
...
\begin{frame}{Objetivos de hoy}
    \begin{itemize}
        \item Funciones reutilizables
        \item Procesamiento batch
        \item Primer avance del proyecto
        \item Feedback personalizado
    \end{itemize}
\end{frame}
...
\begin{frame}{Cierre}
    \begin{center}
        ...
        Próxima semana: Clase teórica 23
    \end{center}
\end{frame}
