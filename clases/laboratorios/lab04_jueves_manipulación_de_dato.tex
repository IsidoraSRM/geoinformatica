...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Laboratorio 4} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Laboratorio 04: Manipulación de datos raster + Inicio proyecto}
\subtitle{Terra y formación de grupos}
...
\begin{frame}{Objetivos de hoy}
    \begin{itemize}
        \item Trabajar con terra
        \item Operaciones básicas raster
        \item Formar grupos de proyecto
        \item Brainstorming inicial
    \end{itemize}
\end{frame}
...
\begin{frame}{Cierre}
    \begin{center}
        ...
        Próxima semana: Clase teórica 9
    \end{center}
\end{frame}
