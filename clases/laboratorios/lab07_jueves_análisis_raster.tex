...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Laboratorio 7} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Laboratorio 07: Análisis raster}
...
\begin{frame}{Objetivos de hoy}
    \begin{itemize}
        \item Cálculo de pendientes y orientación
        \item Análisis de visibilidad
        \item Estadísticas zonales
        \item Proyecto: análisis de riesgo
    \end{itemize}
\end{frame}
...
\begin{frame}{Cierre}
    \begin{center}
        ...
        Próxima semana: Clase teórica 15
    \end{center}
\end{frame}
