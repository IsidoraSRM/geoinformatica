...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Laboratorio 10} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Laboratorio 10: Mapas interactivos}
\subtitle{Visualización web}
...
\begin{frame}{Objetivos de hoy}
    \begin{itemize}
        \item Crear mapas con leaflet
        \item Añadir interactividad
        \item Publicación web básica
        \item Dashboard simple
    \end{itemize}
\end{frame}
...
\begin{frame}{Cierre}
    \begin{center}
        ...
        Próxima semana: Clase teórica 21
    \end{center}
\end{frame}
