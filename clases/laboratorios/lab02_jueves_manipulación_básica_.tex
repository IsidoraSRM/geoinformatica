...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Laboratorio 2} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Laboratorio 02: Manipulación básica de datos vectoriales}
\subtitle{Trabajando con sf en R}
...
\begin{frame}{Objetivos de hoy}
    \begin{itemize}
        \item Lectura de archivos espaciales
        \item Exploración de datos con sf
        \item Operaciones básicas
        \item Visualización simple
    \end{itemize}
\end{frame}
...
\begin{frame}{Cierre}
    \begin{center}
        ...
        Próxima semana: Clase teórica 5
    \end{center}
\end{frame}
