...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Laboratorio 6} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Laboratorio 06: Geoprocesamiento vectorial + Propuesta proyecto}
\subtitle{Análisis espacial y proyecto}
...
\begin{frame}{Objetivos de hoy}
    \begin{itemize}
        \item Implementar buffers y análisis
        \item Overlay de capas
        \item Entregar propuesta de proyecto
...
\begin{frame}{Cierre}
    \begin{center}
        ...
        Próxima semana: Clase teórica 13
    \end{center}
\end{frame}
