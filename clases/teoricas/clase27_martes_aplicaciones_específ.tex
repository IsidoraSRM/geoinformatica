...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Clase 27} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Clase 27: Aplicaciones específicas}
\subtitle{Casos de uso por dominio}
...
\section{Geomarketing y retail}

\begin{frame}{Geomarketing y retail}
...
\section{Análisis ambiental}

\begin{frame}{Análisis ambiental}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Planificación urbana}

\begin{frame}{Planificación urbana}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Gestión de emergencias}

\begin{frame}{Gestión de emergencias}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
