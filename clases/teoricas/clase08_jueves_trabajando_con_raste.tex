...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Clase 8} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Clase 08: Trabajando con raster}
\subtitle{Paquete terra y rasterio}
...
\section{Introducción a terra en R}

\begin{frame}{Introducción a terra en R}
...
\section{Rasterio en Python}

\begin{frame}{Rasterio en Python}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Lectura y escritura de raster}

\begin{frame}{Lectura y escritura de raster}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\begin{frame}{Visualización básica}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
