...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Clase 12} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Clase 12: Geoprocesamiento avanzado}
\subtitle{Queries y análisis complejos}
...
\section{Queries espaciales complejas}

\begin{frame}{Queries espaciales complejas}
...
\section{Operaciones de overlay}

\begin{frame}{Operaciones de overlay}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Análisis de proximidad}

\begin{frame}{Análisis de proximidad}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\begin{frame}{Casos de uso prácticos}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
