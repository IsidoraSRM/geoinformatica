...
\title{Clase 07: Datos raster y su representación}
\subtitle{Estructura y propiedades}
...
\section{Estructura de datos raster}

\begin{frame}{Estructura de datos raster}
...
\section{Resolución espacial y espectral}

\begin{frame}{Resolución espacial y espectral}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Bandas y multicapas}

\begin{frame}{Bandas y multicapas}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Formatos raster comunes}

\begin{frame}{Formatos raster comunes}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
