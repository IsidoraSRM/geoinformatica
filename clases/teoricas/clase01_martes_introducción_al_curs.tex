...
\title{Clase 01: Introducción al curso}
\subtitle{Presentación y contexto de la Geoinformática}
...
\section{Presentación del programa del curso}

\begin{frame}{Presentación del programa del curso}
...
\section{Introducción a la Geocomputación}

\begin{frame}{Introducción a la Geocomputación}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
