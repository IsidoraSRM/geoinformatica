...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Clase 14} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Clase 14: Operaciones raster avanzadas}
\subtitle{Análisis focal, zonal y global}
...
\section{Operaciones focales (vecindad)}

\begin{frame}{Operaciones focales (vecindad)}
...
\section{Operaciones zonales}

\begin{frame}{Operaciones zonales}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Operaciones globales}

\begin{frame}{Operaciones globales}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Análisis multicriterio}

\begin{frame}{Análisis multicriterio}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
