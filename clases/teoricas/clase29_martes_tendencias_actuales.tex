...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Clase 29} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Clase 29: Tendencias actuales}
\subtitle{Estado del arte en Geoinformática}
...
\section{Big Data geoespacial}

\begin{frame}{Big Data geoespacial}
...
\section{Cloud computing (GEE)}

\begin{frame}{Cloud computing (GEE)}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Deep Learning para imágenes}

\begin{frame}{Deep Learning para imágenes}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
