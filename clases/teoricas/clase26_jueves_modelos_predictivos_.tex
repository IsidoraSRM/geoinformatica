...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Clase 26} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Clase 26: Modelos predictivos espaciales}
\subtitle{Machine Learning geoespacial}
...
\begin{frame}{Regresión espacial}
...
\section{Random Forest espacial}

\begin{frame}{Random Forest espacial}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Validación cruzada espacial}

\begin{frame}{Validación cruzada espacial}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Feature engineering geoespacial}

\begin{frame}{Feature engineering geoespacial}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
