...
\begin{frame}{Geometrías Vectoriales Básicas}
    \begin{tikzpicture}[scale=0.9]
        ...
        \node at (4.25,-0.9) {\tiny [(x1,y1), (x2,y2), ...]};
...
\begin{frame}{Modelo Raster: Campos Continuos}
    \begin{columns}
        ...
        \begin{tikzpicture}[scale=0.35]
            % Grilla raster simplificada
            \foreach \x in {0,...,7} {
                \foreach \y in {0,...,7} {
                    % Valores fijos para evitar problemas con rand
                    \pgfmathsetmacro\val{30 + mod(\x+\y*3,40)}
...
\begin{frame}{Resolución Espacial}
    ...
    \begin{tikzpicture}[scale=0.6]
        ...
        \draw[step=0.2, gray, very thin] (0,0) grid (3.2,3.2);
        \fill[green!60] (0.2,0.2) rectangle (0.4,0.4);
        \fill[brown!40] (0.6,0.4) rectangle (0.8,0.6);
        \fill[green!60] (1.0,0.8) rectangle (1.2,1.0);
        \fill[brown!40] (1.4,1.2) rectangle (1.6,1.4);
        \node at (1.5,-0.5) {\tiny 1m/píxel};
        
        % Media resolución
        \node at (5,4) {\textbf{Media Resolución}};
        \draw[thick] (5,0) rectangle (8.2,3.2);
        \draw[step=0.4, gray, very thin] (5,0) grid (8.2,3.2);
        \fill[green!60] (5.4,0.4) rectangle (5.8,0.8);
        \fill[brown!40] (6.2,0.8) rectangle (6.6,1.2);
        \fill[green!60] (5.8,1.6) rectangle (6.2,2.0);
        \node at (6.5,-0.5) {\tiny 10m/píxel};
        
        % Baja resolución
        \node at (10,4) {\textbf{Baja Resolución}};
        \draw[thick] (10,0) rectangle (13.2,3.2);
        \draw[step=0.8, gray, very thin] (10,0) grid (13.2,3.2);
        \fill[green!60] (10.8,0.8) rectangle (11.6,1.6);
        \fill[brown!40] (11.6,1.6) rectangle (12.4,2.4);
