...
\subtitle{Conceptos básicos y herramientas}
...
\begin{frame}{Historia y evolución de la Geocomputación}
...
\begin{frame}{Software para análisis geoespacial}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Ecosistema R y Python para geodatos}

\begin{frame}{Ecosistema R y Python para geodatos}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\begin{frame}{Primeros ejemplos prácticos}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\begin{frame}{Cierre}
    \begin{center}
        ...
        Primer laboratorio: Próxima semana}
    \end{center}
\end{frame}
