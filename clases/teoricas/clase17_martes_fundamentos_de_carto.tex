...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Clase 17} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Clase 17: Fundamentos de cartografía digital}
\subtitle{Principios de diseño de mapas}
...
\section{Elementos de un mapa}

\begin{frame}{Elementos de un mapa}
...
\section{Teoría del color}

\begin{frame}{Teoría del color}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Simbolización efectiva}

\begin{frame}{Simbolización efectiva}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Jerarquía visual}

\begin{frame}{Jerarquía visual}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
