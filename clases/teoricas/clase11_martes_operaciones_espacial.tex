...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Clase 11} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Clase 11: Operaciones espaciales vectoriales}
\subtitle{Geoprocesamiento fundamental}
...
\section{Buffer, intersección, unión}

\begin{frame}{Buffer, intersección, unión}
...
\section{Diferencia y diferencia simétrica}

\begin{frame}{Diferencia y diferencia simétrica}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Predicados espaciales}

\begin{frame}{Predicados espaciales}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Relaciones topológicas}

\begin{frame}{Relaciones topológicas}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
