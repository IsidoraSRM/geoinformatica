...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Clase 15} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Clase 15: Interacciones raster-vector}
\subtitle{Integración de tipos de datos}
...
\section{Extracción de valores raster}

\begin{frame}{Extracción de valores raster}
...
\section{Estadísticas por polígono}

\begin{frame}{Estadísticas por polígono}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Máscaras y recortes}

\begin{frame}{Máscaras y recortes}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Sampling de puntos}

\begin{frame}{Sampling de puntos}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
