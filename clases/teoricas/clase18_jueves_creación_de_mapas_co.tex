...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Clase 18} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Clase 18: Creación de mapas con tmap}
\subtitle{Mapas estáticos profesionales}
...
\section{Sintaxis de tmap}

\begin{frame}{Sintaxis de tmap}
...
\section{Layouts y composición}

\begin{frame}{Layouts y composición}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Mapas temáticos}

\begin{frame}{Mapas temáticos}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Exportación de alta calidad}

\begin{frame}{Exportación de alta calidad}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
