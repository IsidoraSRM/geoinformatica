...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Clase 16} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Clase 16: Conversión entre formatos}
\subtitle{Rasterización y vectorización}
...
\section{Rasterización de vectores}

\begin{frame}{Rasterización de vectores}
...
\section{Vectorización de raster}

\begin{frame}{Vectorización de raster}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Parámetros de conversión}

\begin{frame}{Parámetros de conversión}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Preservación de información}

\begin{frame}{Preservación de información}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
