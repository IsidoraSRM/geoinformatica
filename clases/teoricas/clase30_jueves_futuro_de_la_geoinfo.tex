...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Clase 30} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Clase 30: Futuro de la Geoinformática}
...
\section{Gemelos digitales}

\begin{frame}{Gemelos digitales}
...
\begin{frame}{Computación cuántica}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\begin{frame}{Ética y privacidad}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\begin{frame}{Cierre}
    \begin{center}
        ...
        Próxima semana: Presentaciones de proyectos
    \end{center}
\end{frame}
