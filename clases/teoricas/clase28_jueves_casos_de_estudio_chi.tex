...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Clase 28} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Clase 28: Casos de estudio Chile}
\subtitle{Aplicaciones locales}
...
\section{Análisis de movilidad Santiago}

\begin{frame}{Análisis de movilidad Santiago}
...
\section{Gestión de recursos hídricos}

\begin{frame}{Gestión de recursos hídricos}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Monitoreo de incendios}

\begin{frame}{Monitoreo de incendios}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
...
\section{Planificación territorial}

\begin{frame}{Planificación territorial}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
