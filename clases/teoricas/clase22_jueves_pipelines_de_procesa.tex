...
\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth,sep=2ex]{footline}%
    \usebeamerfont{structure}\textbf{Geoinformática - Clase 22} \hfill Profesor: Francisco Parra O. \hfill \textbf{Semestre 2, 2025}
  \end{beamercolorbox}%
}

\title{Clase 22: Pipelines de procesamiento}
\subtitle{Automatización de flujos de trabajo}
...
\section{Procesamiento batch}

\begin{frame}{Procesamiento batch}
...
\begin{frame}{Optimización de código}
    % Contenido a desarrollar en clase
    \begin{itemize}
        \item Concepto clave 1
        \item Concepto clave 2
