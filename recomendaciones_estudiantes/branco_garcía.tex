...
\begin{center}
    ...
    {\LARGE \textbf{Branco García}}\\[0.2cm]
    {\large Fecha: \today}
\end{center}
...
\textit{"Analizar las zonas urbanas donde se acumula más gente o haya más densidad poblacional, que requiere tener acceso a transporte público rápido."}
