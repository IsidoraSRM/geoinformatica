...
\begin{center}
    ...
    {\LARGE \textbf{Aracely Castro}}\\[0.2cm]
    {\large Fecha: \today}
\end{center}
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Lenguajes dominados:} R, Python, SQL
    \item \textbf{Áreas de interés:} Medioambiente
    \item \textbf{Stack tecnológico recomendado:} GeoPandas, Folium, Rasterio + sf, terra, tmap + PostGIS
\end{itemize}
\end{tcolorbox}
...
\textit{"Algo que pueda recopilar el movimiento de animales dentro de una zona para saber como entran al campo del vecino o donde ponen más las gallinas sus huevos"}
