-- Crear extensiones espaciales básicas
CREATE EXTENSION IF NOT EXISTS postgis;
CREATE EXTENSION IF NOT EXISTS postgis_topology;
CREATE EXTENSION IF NOT EXISTS postgis_raster;
-- CREATE EXTENSION IF NOT EXISTS pgrouting; -- No disponible en Alpine
CREATE EXTENSION IF NOT EXISTS fuzzystrmatch;
-- CREATE EXTENSION IF NOT EXISTS postgis_tiger_geocoder; -- No disponible en Alpine  
-- CREATE EXTENSION IF NOT EXISTS address_standardizer; -- No disponible en Alpine
